...
#[cfg(feature = "hsm6")]
pub use zk_ctx_device::get_random_bytes;

#[cfg(not(feature = "hsm6"))]
pub use default::get_random_bytes;
...
pub mod zk_ctx_device {
    ...
    pub fn get_random_bytes(num_bytes: i32) -> std::result::Result<Vec<u8>, DeviceError> {
        let hsm6 = ZkCtx::new()?;
